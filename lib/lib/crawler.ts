      ...
      issues: [
        {
          ...
          detail:
            "The crawler could not parse the supplied website URL.",
          url: startUrl,
        },
      ],
    };
      ...
      issues: [
        {
          ...
          title: "Invalid website URL",
          detail:
            "Only HTTP and HTTPS website URLs can be crawled.",
          url: startUrl,
        },
      ],
    };
  ...
  while (
    ...
    try {
      ...
      issues.push({
        ...
        detail:
          `The crawler could not retrieve this page: ${message}`,
        url: currentUrl,
      });
    }
  }
